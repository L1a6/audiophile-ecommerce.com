...
const Checkout: React.FC = () => {
  ...
  // Store completed order details for thank you modal
    ...
    const loadCart = () => {
      try {
        ...
        if (stored) {
          ...
          console.log('✅ Loaded and validated cart:', validatedCart);
        ...
        <div className="thank-you-modal">
          ...
          <div className="thank-you-content">
            <div className="thank-you-items">
              {completedOrder.items.slice(0, showAllItems ? completedOrder.items.length : 1).map(item => (
              ...
              {completedOrder.items.length > 1 && (
                <>
                  ...
                  >
                    {showAllItems ? 'View less' : `and ${completedOrder.items.length - 1} other item(s)`}
                  </button>
                </>
              )}
            </div>
            <div className="thank-you-total">
              ...
              <p className="thank-you-total-amount">{formatPrice(completedOrder.grandTotal)}</p>
            </div>
          </div>
